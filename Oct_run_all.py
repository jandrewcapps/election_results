...
os.system('python Oct_MP_Precinct_scrape.py')
os.system('python Oct_MP_Totals_scrape.py')
os.system('python Oct_C1_scrape.py')
os.system('python Oct_C2_scrape.py')
os.system('python Oct_C4_scrape.py')
os.system('python Oct_C5_scrape.py')
os.system('python Oct_P2_scrape.py')
os.system('python Oct_P3_scrape.py')
os.system('python Oct_P5_scrape.py')
